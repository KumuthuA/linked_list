...
int main(int argc, char *argv[])
{
    ...
    {
        pthread_create(&thread_handlers[i], NULL, (void *)Thread_function, i);
    }
    ...
    fpt = fopen("linked_list_with_one_mutex_case_3_thread8.csv", "a");
...
void *Thread_function(void *rank)
{
    ...
    {
        int r = rand() % (1 << 16);
        // printf("index: %d ;thread: %d value: %d ; num_member:  %d \n ", count_m, rank, r, num_member);
